...
struct Tag {
    Int v = 0;
    void operator+=(const Tag<Int> &o) { v += o.v; }
    bool check() { return v != 0; }
};
...
class SegTree {
   ...
   public:
    ...
    void update(int l, int r, Tag<Int> v) { update(1, 1, n, l, r, v); }

    void modify(int pos, Int v) { modify(1, 1, n, pos, v); }

    Info<Int> ask(int l, int r) { return ask(1, 1, n, l, r); }
};
